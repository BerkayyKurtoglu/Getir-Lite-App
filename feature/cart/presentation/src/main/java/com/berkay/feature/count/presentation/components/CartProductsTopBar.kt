...
@Composable
fun CartProductsTopBar(
    modifier: Modifier = Modifier,
    titleText: String,
    shouldShowRemoveAllButton: Boolean,
    onBackClicked: () -> Unit,
        ...
        ConstraintLayout(
            ...
            if (shouldShowRemoveAllButton){
                Box(
                    ...
                    Icon(
                        painter = painterResource(R.drawable.ic_getir_trash),
                        contentDescription = "BackButton",
                        tint = localColorScheme.mainGetirWhite
                    )
                }
            }
        }
